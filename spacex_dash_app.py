...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
        id='payload-slider',
        min=min_payload,  # Slider starting point
        max=max_payload,  # Slider ending point
        step=1000,  # Slider interval
        value=[min_payload, max_payload],  # Default range
        marks={i: str(i) for i in range(int(min_payload), int(max_payload) + 1, 1000)},  # Marks on the slider
    ),
